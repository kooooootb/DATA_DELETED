...
public:
	 ...
	 */
	Operative(Level *level, std::string &name, Point &coord, int healthMax, int timeMax, int walkTime, int viewRadius, float reloadTime, int force, float accuracy);
	...
	/*!
	 * Использует предмет из инвентаря оперативника
	 * @param index номер предмета в таблице инвентаря
	 */
